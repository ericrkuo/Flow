    ...
    * */
    ...
    getFeatures(mood) {
        ...
        return executeMethod(() => {
            return this.spotifyApi.getAudioFeaturesForTracks(emotionMap[mood]);
        })
            .then((res) => {
                ...
                const songFeatures = {};
                for (const feature of this.features) songFeatures[feature] = 0;
                for (const audioFeature of res.body["audio_features"]) {
