...
const webcamLimiter = rateLimit({
    ...
    message: {errorMsg: "Too many requests from this IP, please try again after an hour"}
});

const trackLimiter = rateLimit({
    windowMs: 10 * 60 * 1000, // 10 min window
    max: 5, // start blocking after 5 requests
    message: {errorMsg: "Too many playlists created from this IP, please try again after 10 minutes"}
});
